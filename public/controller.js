...
.controller('mainController', function($scope, $http) {
	 ...
	 * Note: Definitely not the best solution, but it works
	 problemmmmmm 8!!
	 */
	$scope.updateDatesList = function() {
		
		var updateList = function(dates) {
			$scope.dates = []
	 ...
	 */
	 // cela api//2013-12-28/2016-09-30 404 1ms - 
	 //  chagement a faire ici
	$scope.getCarbonFootprint = function() {
		//var oneDate = $scope.oneDate,
			min  = $scope.dates.min,
			max  = $scope.dates.max;
...
*/
			    	// Update data
			    	$scope.getCarbonFootprint($scope.oneDate);
			    });
            });
        }
    };
